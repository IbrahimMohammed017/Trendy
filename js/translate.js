const translat = {
  en: {
    ...
    promore: "For More Details",
    proclick: "Click Here",
    artintro:
      "Because we care about your health, so we give you important medical information",
    artmore: "Browse here",
    abouthead: "Who Are We ?",
    aboutintro:
    ...
    aboutmore: "To Know More about Us",
    ...
    conp: "Don't hesitate to contact us, our team is happy to serve you",
    add: "Our Address:",
    addlink:
    ...
    kamp: "Expert and consultant in the field of Economy, Banking, Finance and Taxes, In addition to great experience in the field of marketing and sales, All these experiences were gained through his previous working positions:",
    ...
    famp7: "NFSA registration number 716/2020.",
    dosage: "Dosage:",
    ...
    neli8: "NFSA Registration Number 717/2020.",
    ...
    getmore: "Get More",
    child: "Keep out from reach of children.",
    vd3li1: "Provides balanced iron concentration in the blood.",
    vd3li2: "Supports immunity.",
    vd3li3: "Protects cells against oxidative stress.",
    vd3li4: "Provides healthy hair and avoids hair loss.",
    vd3li5: "Supports healthy skin tissues.",
    vd3p1: "NFSA registration number 716/2020.",
    vd3li6: "Supports immunity.",
    vd3li7: "For anemic patient.",
    vd3li8: "Hematinic and General Tonic.",
    vd3li9: "Normal oxygen supply.",
    vd3li10: "Protects cells against oxidative stress.",
    vd3li11: "Reduces tiredness and fatigue.",
    vd3li12: "Influences iron utilization for optimum physical performance.",
    vd3li13: "Provides healthy hair and avoids hair loss.",
    vd3li14: "Supports healthy skin tissues.",
    vitp7: "A rich source of Multivitamins and minerals.",
    josp: "Expert In:",
    linkspan1:
  ...
  ar: {
    ...
    famp7: "رقم التسجيل لدى الهيئة القومية لسلامة الغذاء : ٢٠٢٠/٧١٦.",
    dosage: "الجرعة:",
    ...
    neli8: "رقم التسجيل لدى الهيئة القومية لسلامة الغذاء: ٧١٧/٢٠٢٠.",
    ...
    child: "يحفظ بعيداً عن متناول الأطفال.",
    vd3li1: "يوفر تركيزاً متوازناً من الحديد فى الدم.",
    vd3li2: "يدعم المناعة.",
    vd3li3: "يحمى الخلايا من الإجهاد التأكسدى.",
    vd3li4: "يوفر شعراً صحياً ويمنع تساقط الشعر.",
    vd3li5: "يدعم صحة أنسجة الجلد.",
    vd3p1: "مسجل لدى الهيئة القومية لسلامة الغذاء برقم: ٧١٦/٢٠٢٠.",
    vd3li6: "يدعم المناعة.",
    vd3li7: "لمريض فقر الدم.",
    vd3li8: "منشط للهيماتين والعامة.",
    vd3li9: "إمدادات الأكسجين العادية.",
    vd3li10: "يحمى الخلايا من الإجهاد التأكسدى.",
    vd3li11: "يقلل من التعب والإرهاق.",
    vd3li12: "يؤثر على إستخدام الحديد لتحقيق الأداء البدنى الأمثل.",
    vd3li13: "يوفر شعراً صحياً ويمنع تساقط الشعر.",
    vd3li14: "يدعم صحة أنسجة الجلد.",
    vitp7: "مصدر غنى بالفيتامينات والمعادن التى يحتاجها الجسم.",
